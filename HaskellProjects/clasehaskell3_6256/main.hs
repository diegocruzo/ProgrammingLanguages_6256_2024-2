...
-- Función compuesta (también es pura)
...
-- Funciones con coincidencia de patrones (pattern matching)
numeroDeLaSuerte :: Int -> String
numeroDeLaSuerte 7 = "Has adivinado el num. de la suerte!"
numeroDeLaSuerte 5 = "Otro num. de la suerte!"
...
esPar x = 
    ...
    if x `mod` 2 == 0 -- Función "mod" está escrita de forma infija
